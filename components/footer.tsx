  ...
  return (
    <footer className="py-16 md:py-32">
      <div className="mx-auto max-w-5xl px-6">
        ...
        <span className="text-muted-foreground block text-center text-sm mb-2 bg-blue-50 p-2 rounded-2xl">
          Bilişim Vadisi - Istinye University Ayazağa Neighborhood, Kemerburgaz
          Street Vadi Istanbul Park Block 7A, No: 7B, Internal Door No: 4
          Sarıyer / Istanbul Phone: +90 212 613 58 80 Fax: +90 212 322 04 11
        </span>
